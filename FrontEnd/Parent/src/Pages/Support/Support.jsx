  ...
  const supportDirectory = [
    {
      ...
      description: "Inquiries regarding student academic progress, parent-teacher meetings, and curriculum tracks.",
      icon: "👨‍🏫",
      contact: {
    ...
    },
    {
      ...
      description: "Official institutional approvals, registration records, high-level structural guidance, and leave updates.",
      icon: "🏛️",
      contact: {
    ...
    },
    {
      ...
      role: "IT Desk / App Support",
      description: "Assistance with parent portal password resets, account locking, and child dashboard tracking setups.",
      icon: "🛠️",
      contact: {
        name: "Parent Help Desk",
        ...
        {/* FAQ Section Matching the Theme */}
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
            ...
            <div className="space-y-4">
              {[
                "Where do I download my child's report card?",
                "How to request school transport updates?",
                "Who do I notify if my child is absent?",
                "When are online portal payments verified?"
              ].map((q, i) => (

...
const Assignment = () => {
  ...
  const [formCourse, setFormCourse] = useState("History 101");
  ...
  // Parses form date input text to standard display strings (e.g. "June 04, 2026")
  ...
  const handleCreateAssignment = (e) => {
    e.preventDefault();
    if (!formTitle.trim()) return alert("Please specify an assignment title.");
    ...
    const newAssignment = {
      ...
      submissions: 0,
      gradedCount: 0,
      totalStudents: 30 // Fallback configuration default metric
    };
    ...
    <div className="w-full max-w-7xl mx-auto p-1 font-sans text-slate-900">
      <div className="space-y-5">
        ...
        <div className="bg-white rounded-xl border border-slate-200/80 shadow-sm overflow-hidden transition-all">
          ...
          {isComposerOpen && (
            <form onSubmit={handleCreateAssignment} className="p-5 border-t border-slate-100 space-y-4 bg-white text-left animate-fadeIn">

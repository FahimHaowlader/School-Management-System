...
const StudentRow = ({ status, name, emailAddress, studentId, studentPhone, gradeLevel, imageUrl }) => {
  const badgeStyles = {
  ...
  return (
    <tr className="border-b border-slate-200/70 hover:bg-slate-50/70 transition-colors">
      ...
      {/* Student Direct Contact Phone Number */}
      <td className="p-4 align-middle text-left font-mono text-xs text-slate-700 font-medium">
        {studentPhone}
      </td>

      {/* Assigned Academic Grade Level */}
      ...
      {/* Row Control Interactions */}
      <td className="p-4 align-middle text-right">
        <div className="flex items-center justify-end gap-1.5">
          <button 
            onClick={() => console.log("Modify student records")}
          ...
          <button 
            onClick={() => console.log("Remove student item record")}
...
const Student = () => {
  const grades = ["All Grades", "12th Grade", "11th Grade", "10th Grade", "9th Grade"];
      ...
      <div className="space-y-5">
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200/60 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="text-left">
            <h2 className="text-sm font-bold text-slate-900 tracking-tight">Active Student Registry Matrix</h2>
            <p className="text-xs text-slate-400 font-medium mt-0.5">Manage enrolled student profiles, direct phone numbers, status classifications, and grade cohorts.</p>
          </div>
          ...
          <div className="flex items-center gap-4 border-l border-transparent sm:border-slate-100 sm:pl-4">
            <div className="text-center sm:text-right">
              ...
              <span className="text-[10px] uppercase font-bold tracking-wider text-slate-400">Students Matriculated</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200/80 shadow-sm overflow-hidden transition-all">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-bold text-slate-800 tracking-wide">Register New Student Record</span>
            </div>
            ...
            <div className="p-5 border-t border-slate-100 space-y-4 bg-white text-left animate-fadeIn">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-[11px] uppercase font-bold text-slate-500 tracking-wider">Student Full Name</label>
                  <input 
                    type="text" 
                    placeholder="e.g., Benjamin Parker" 
                ...
                <div className="space-y-1">
                  <label className="text-[11px] uppercase font-bold text-slate-500 tracking-wider">Student Email Address</label>
                  <input 
                    type="email" 
                    placeholder="e.g., b.parker@student.edu" 
                    className="w-full h-10 px-3 border border-slate-200 rounded-lg text-xs outline-none focus:border-slate-900 transition-colors"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="space-y-1 md:col-span-2">
                  <label className="text-[11px] uppercase font-bold text-slate-500 tracking-wider">Contact Phone Number</label>
                  <input 
                    type="text" 
                ...
                <div className="space-y-1">
                  <label className="text-[11px] uppercase font-bold text-slate-500 tracking-wider">Academic Cohort</label>
                ...
                <div className="space-y-1">
                  <label className="text-[11px] uppercase font-bold text-slate-500 tracking-wider">Registration Status</label>
                  <select className="w-full h-10 px-3 border border-slate-200 rounded-lg text-xs font-semibold bg-white outline-none focus:border-slate-900 transition-colors">
              ...
              <div className="space-y-1.5">
                <label className="text-[11px] uppercase font-bold text-slate-500 tracking-wider">Official Identification Portrait</label>
                <div className="border border-dashed border-slate-200 rounded-xl p-5 bg-slate-50/50 hover:bg-slate-50 transition-colors flex flex-col items-center justify-center gap-1.5 group/dropzone cursor-pointer relative">
                  ...
                  <p className="text-xs font-bold text-slate-700 mt-0.5">Upload verified student campus profile photograph</p>
        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-3">
          <div className="relative flex-grow h-11 group">
            <input 
              type="text" 
              placeholder="Search matrix records by student name, system ID index, phone number, or grade levels..." 
            ...
            <table className="w-full border-collapse text-left">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200/80 text-[10px] font-bold text-slate-400 uppercase tracking-wider">
                  <th className="p-4">Student Information</th>
                  <th className="p-4">Student ID</th>
                  <th className="p-4">Phone Number</th>
                  <th className="p-4">Academic Cohort</th>
              ...
              <tbody className="divide-y divide-slate-100">
                <StudentRow 
                  ...
                  emailAddress="l.henderson@student.edu"
                  studentId="STU-2026-881"
                  studentPhone="(555) 019-2281"
                ...
                <StudentRow 
                  status="Suspended"
                  name="Chloe Zhao"
                  emailAddress="c.zhao@student.edu"
                  studentId="STU-2026-440"
                  studentPhone="(555) 011-3094"
                ...
                <StudentRow 
                  status="Active"
                  name="Amara Okafor"
                  emailAddress="a.okafor@student.edu"
                  studentId="STU-2026-119"
                  studentPhone="(555) 015-7762"

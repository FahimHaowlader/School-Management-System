...
import { 
  ...
  ArrowRight, Fingerprint, Briefcase
} from 'lucide-react';
...
const TechnicianAddStaff = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Staff Registration Data (Technician Console):", formData);
  };
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm hover:shadow-md transition-shadow duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2">
              ...
              <input name="fullName" type="text" placeholder="e.g. Abir Hasan" className="w-full px-5 py-3.5 rounded-2xl border border-slate-200 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none bg-gray-50/30 transition-all font-medium" onChange={handleChange} required />
            </div>
            <div>
            ...
            <div>
              ...
              <input name="email" type="email" placeholder="staff.name@school.edu.bd" className="w-full px-5 py-3.5 rounded-2xl border border-slate-200 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none bg-gray-50/30 transition-all font-medium" onChange={handleChange} />
            </div>
            <div>
              <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest mb-2 block ml-1">Mobile Number</label>
              <input name="phone" type="tel" placeholder="+880 1XXX XXXXXX" className="w-full px-5 py-3.5 rounded-2xl border border-slate-200 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none bg-gray-50/30 transition-all font-medium" onChange={handleChange} />
            </div>
        ...
        <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm hover:shadow-md transition-shadow duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest mb-2 block ml-1">Staff Role / Category</label>
              <select name="role" className="w-full px-5 py-3.5 rounded-2xl border border-slate-200 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none bg-gray-50/30 font-medium appearance-none" onChange={handleChange}>
                <option value="">Select Role</option>
                <option>Security / Campus Safety</option>
                <option>Maintenance & IT Support</option>
            ...
            <div>
              <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest mb-2 block ml-1">Work Shift</label>
              <select name="shift" className="w-full px-5 py-3.5 rounded-2xl border border-slate-200 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none bg-gray-50/30 font-medium appearance-none" onChange={handleChange}>
                <option value="">Select Shift</option>
                <option>Morning (08:00 AM - 02:00 PM)</option>
                <option>Day (10:00 AM - 05:00 PM)</option>
                <option>Evening (02:00 PM - 09:00 PM)</option>
                <option>Night (09:00 PM - 06:00 AM)</option>
              </select>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm hover:shadow-md transition-shadow duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input name="emergencyName" type="text" placeholder="Name of family member" className="w-full px-5 py-3.5 rounded-2xl border border-slate-200 focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500 outline-none bg-gray-50/30 transition-all font-medium" onChange={handleChange} />
            </div>
            <div>
        ...
        <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm hover:shadow-md transition-shadow duration-300">
          ...
          <div className="border-2 border-dashed border-slate-100 rounded-[2rem] p-12 bg-gray-50/10 flex flex-col items-center hover:border-indigo-400 hover:bg-indigo-50/10 transition-all group relative cursor-pointer">
            ...
            <p className="text-sm font-bold text-slate-600">NID Copy / Employment Contract</p>

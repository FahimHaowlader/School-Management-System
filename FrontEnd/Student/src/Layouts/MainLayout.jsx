      ...
      <div className='flex flex-grow'>
        ...
        >
          ...
          <div 
            ...
            className='h-16 flex-shrink-0 bg-white flex items-center justify-between px-6 cursor-pointer border-b border-slate-200  transition-colors sticky top-0 z-20'
          >
            {!isMinimized ? (
              <>
                <span className="font-black text-slate-900 text-xl tracking-tight">My<span className="text-slate-500 font-medium">class</span></span>
              </>
            ) : (
              <div className="w-full flex items-center justify-center">
                <span className="font-black text-slate-900 text-lg bg-slate-100 w-10 h-10 flex items-center justify-center rounded-xl shadow-inner px-4">M</span>
              </div>
            )}
          </div>
          ...
          <div className='overflow-y-auto p-3 flex-grow custom-scrollbar' style={{ direction: 'rtl' }}>
            <div style={{ direction: 'ltr' }} className='space-y-1' >
              ...
              <NavLink to="/event" onClick={() => setActiveTitle("Event")} className={navLinkClasses}>
                <div className="flex items-center justify-center flex-shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v18.25M6.75 3A13.5 13.5 0 0 0 21 7.5c0-4.142-3.358-7.5-7.5-7.5a13.5 13.5 0 0 0-6.75 3Zm0 0a13.5 13.5 0 0 1-6.75 3c0-4.142 3.358-7.5 7.5-7.5a13.5 13.5 0 0 1 6.75 3Z" /></svg>
                </div>
...
<header className='h-16 bg-slate-50/70 backdrop-blur-md w-full flex items-center justify-between px-8 sticky top-0 z-20  shadow-sm shadow-slate-100/40'> 
  <div className='flex flex-col text-left'>
    <h1 className='text-xl font-black text-slate-900 tracking-tight leading-none'>{activeTitle}</h1>
  ...
  <div className="flex items-center gap-4">
    ...
    <button 
      ...
      className="h-12 w-12 border border-slate-200 bg-white text-slate-600 rounded-xl hover:bg-slate-900 hover:border-slate-950 hover:text-white transition-all shadow-sm flex items-center justify-center group box-border flex-shrink-0"
      title="Logout Account"
    >
      <svg xmlns="http://www.w3.org/2000/xl" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 transform group-hover:translate-x-1 transition-transform">
